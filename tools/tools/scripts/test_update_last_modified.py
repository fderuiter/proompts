...
from tools.scripts.update_last_modified import update_file
...
class TestUpdateLastModified(unittest.TestCase):
    ...
    @patch("tools.scripts.update_last_modified.datetime")
    ...
    @patch("tools.scripts.update_last_modified.sys.argv", ["update_last_modified.py"])
