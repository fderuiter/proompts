...
from tools.scripts.check_prompts import (
    check_overview,
...
class TestCheckPrompts(unittest.TestCase):
    ...
    @patch('tools.scripts.check_prompts.load_yaml')
    ...
    @patch('tools.scripts.check_prompts.check_directory_contents')
    @patch('tools.scripts.check_prompts.check_overview')
    @patch('tools.scripts.check_prompts.check_prompt_file')
    @patch('tools.scripts.check_prompts.iter_workflow_files')
    @patch('tools.scripts.check_prompts.iter_prompt_files')
    @patch('tools.scripts.check_prompts.WORKFLOWS_DIR', new_callable=lambda: Path('/fake/workflows'))
