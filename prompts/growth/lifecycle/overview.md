...
- **[predictive_rfm_churn_mitigation_architect](predictive_rfm_churn_mitigation_architect.prompt.yaml)**: Mathematically models predictive churn risks using Recency-Frequency-Monetary (RFM) analysis and designs cross-channel behavioral trigger sequences for enterprise SaaS retention.
