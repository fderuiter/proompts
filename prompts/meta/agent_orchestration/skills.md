...
<!-- VALIDATION_METADATA: {"variables": [{"name": "problem_space", "description": "The initial problem space or query requiring multi-agent consensus.", "required": true}, {"name": "agent_hypotheses", "description": "The set of initial hypotheses generated by heterogeneous, autonomous sub-agents.", "required": true}], "metadata": {}} -->
### Description
...
<!-- VALIDATION_METADATA: {"variables": [{"name": "initial_hypothesis", "description": "The originating epistemic state or initial conceptual hypothesis prior to multi-agent recursion.", "required": true}, {"name": "iterative_trajectory", "description": "The log of multi-agent recursive interactions or reasoning steps that may contain semantic drift.", "required": true}], "metadata": {}} -->
### Description
