...
- **[Zero-Knowledge Proof Protocol Architect](zero_knowledge_proof_protocol_architect.prompt.yaml)**: Acts as a Principal Cryptographic Protocol Architect to design mathematically rigorous, operationally viable zero-knowledge proof (ZKP) protocols for enterprise privacy-preserving identity and transaction verification.
