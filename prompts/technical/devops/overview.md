...
- **[Infrastructure Configuration Drift Remediation Architect](infrastructure_configuration_drift_remediation_architect.prompt.yaml)**: Designs and enforces rigorous automated workflows to detect, analyze, and remediate Infrastructure as Code (IaC) configuration drift, ensuring the actual state of cloud resources continuously aligns with the declared state.
