...
- **[Autonomous Automation Agent Upgrade](autonomous_automation_agent_upgrade.prompt.yaml)**: Executes a fully autonomous repository commit and generates a pull request based on the current workspace state.
