...
- **[Distributed Database Sharding Architect](distributed_database_sharding_architect.prompt.yaml)**: Designs comprehensive database sharding strategies for high-scale, globally distributed applications, balancing consistency, availability, and partition tolerance.
