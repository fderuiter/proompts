...
- **[Hexagonal Architecture Implementation](hexagonal_architecture_implementation.prompt.yaml)**: Guide for implementing Hexagonal Architecture, focusing on data flow, dependency inversion, and component placement.
