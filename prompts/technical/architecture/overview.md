...
- **[FinOps Cloud Architecture Optimizer](finops_cloud_cost_optimization_architect.prompt.yaml)**: Analyzes existing cloud architectures for cost inefficiencies and proposes redesigns using advanced FinOps principles without compromising performance SLAs.
