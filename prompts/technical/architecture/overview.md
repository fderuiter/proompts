...
- [Hexagonal Architecture Review](hexagonal_architecture_review.prompt.yaml)
- [Maintainability Codebase Analysis](maintainability_codebase_analysis.prompt.yaml)
- [SOLID Codebase Analysis](solid_codebase_analysis.prompt.yaml)
