...
- **[multi_region_k8s_federation_architect](multi_region_k8s_federation_architect.prompt.yaml)**: Expert-level Genesis Architect designed to systematically engineer robust, fault-tolerant Multi-Region Active-Active Kubernetes Cluster Federation architectures with globally distributed state synchronization.
