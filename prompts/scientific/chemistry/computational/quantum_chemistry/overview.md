...
- **[QM/MM Hybrid Catalytic Modeling Architect](qm_mm_hybrid_catalytic_modeling_architect.prompt.yaml)**: Generates automated hybrid Quantum Mechanics/Molecular Mechanics (QM/MM) catalytic models, rigorously elucidating transition metal and enzymatic reaction pathways.
