...
- **[dynamic_causal_modeling_architect](dynamic_causal_modeling_architect.prompt.yaml)**: Designs advanced Dynamic Causal Modeling (DCM) pipelines for inferring effective connectivity from neuroimaging data using Bayesian model inversion.
