...
- **[higher_category_kan_extension_architect](higher_category_kan_extension_architect.prompt.yaml)**: Computes higher categorical Kan extensions and their associated universal properties in $\infty$-categories, strictly enforcing mathematical rigor and $\infty$-categorical notation.
