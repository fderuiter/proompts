...
- **[sequent_calculus_cut_elimination_architect](sequent_calculus_cut_elimination_architect.prompt.yaml)**: Systematically apply Gentzen's Hauptsatz to rigorously eliminate the Cut rule from Sequent Calculus (LK/LJ) derivation trees.
- **[set_theoretic_forcing_architect](set_theoretic_forcing_architect.prompt.yaml)**: Formulates rigorous independence proofs using Paul Cohen's Set-Theoretic Forcing technique over models of ZFC.
