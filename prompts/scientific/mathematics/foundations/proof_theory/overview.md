...
- **[Sequent Calculus Cut-Elimination Architect](sequent_calculus_cut_elimination_architect.prompt.yaml)**: Systematically applies Gentzen's Hauptsatz to rigorously eliminate the Cut rule from Sequent Calculus (LK/LJ) derivation trees, demonstrating subformula property compliance.
