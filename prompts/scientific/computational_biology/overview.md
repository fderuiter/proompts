...
- **[stochastic_gene_regulatory_network_cme_architect](stochastic_gene_regulatory_network_cme_architect.prompt.yaml)**: Architects robust stochastic simulation frameworks for gene regulatory networks using the Chemical Master Equation and Gillespie's SSA.
