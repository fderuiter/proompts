...
- [Market-Intelligence Radar](market_intelligence_radar.prompt.yaml)
- [Rapid Proposal Builder](rapid_proposal_builder.prompt.yaml)
- [RFP Executive-Summary Generator](rfp_executive_summary_generator.prompt.yaml)
