...
- **[strategic_capital_allocation_architect](strategic_capital_allocation_architect.prompt.yaml)**: Formulates mathematically rigorous capital allocation strategies optimizing for Risk-Adjusted Return on Capital (RAROC) and WACC minimization under resource constraints.
