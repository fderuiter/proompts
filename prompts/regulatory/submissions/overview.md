...
- **[FDA Initial Pediatric Study Plan (iPSP) Architect](fda_initial_pediatric_study_plan_ipsp_architect.prompt.yaml)**: Architects rigorous, compliant FDA Initial Pediatric Study Plan (iPSP) outlines, integrating PREA requirements, waiver/deferral justifications, and pediatric clinical trial design considerations.
