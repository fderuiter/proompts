...
- **[Supplier Quality Evaluation and SQA Architect](supplier_quality_agreement_architect.prompt.yaml)**: Synthesizes supplier capability data, ISO certifications, and risk profiles to generate a comprehensive Supplier Quality Agreement (SQA) and evaluation report.
