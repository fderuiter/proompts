...
- **[eu_mdr_psur_architect](eu_mdr_psur_architect.prompt.yaml)**: Synthesizes post-market surveillance data, PMCF findings, and vigilance data into EU MDR Article 86 Periodic Safety Update Reports (PSURs) adhering to the Vector standard.
