...
- **[MDSAP Nonconformity Grading Evaluator](mdsap_nonconformity_grading_evaluator.prompt.yaml)**: A highly robust, expert-level prompt template to systematically grade Medical Device Single Audit Program (MDSAP) nonconformities based on GHTF/SG3/N19:2012 principles, determining final nonconformity grade (1-5) and escalation criteria.
