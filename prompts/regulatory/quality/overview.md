...
- **[capa_root_cause_analysis_architect](capa_root_cause_analysis_architect.prompt.yaml)**: Acts as a Principal Quality Assurance Architect and Lead Investigator to rigorously conduct Root Cause Analysis (RCA) and formulate Corrective and Preventive Actions (CAPA) for critical manufacturing nonconformances per ISO 13485 and FDA 21 CFR Part 820.
