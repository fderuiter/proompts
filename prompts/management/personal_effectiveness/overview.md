...
- [Learning Path Mentor](learning_path_mentor.prompt.yaml)
- [Micro-Habit Health Coach](micro_habit_health_coach.prompt.yaml)
- [Second-Order Thinking Oracle](second_order_thinking_oracle.prompt.yaml)
