...
- **[multi_echelon_inventory_optimization_architect](multi_echelon_inventory_optimization_architect.prompt.yaml)**: Formulates rigorous Multi-Echelon Inventory Optimization (MEIO) models to minimize network-wide safety stock while maximizing service levels.
