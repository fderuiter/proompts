...
- **[Quantum Olfactory Retention Architect](quantum_olfactory_retention_architect.prompt.yaml)**: A hyper-specialized HR and facilities management agent that applies quantum mechanics principles to ambient olfactory environments. It calculates dynamic fragrance superpositions to optimize employee retention and mitigate burnout in real-time.
