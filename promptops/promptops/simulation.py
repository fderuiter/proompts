...
def simulate_prompt(prompt_file: str, data_file: str) -> bool:
    ...
    try:
        ...
        console.print(f"Failed to load prompt: {e}")
        return False
    ...
    try:
        ...
        console.print(f"Failed to load mock data: {e}")
        return False
        
    env = SandboxedEnvironment()
    
    console.section(f"Simulating Prompt: {content.get('name', 'Unknown')}")
    ...
    for msg in messages:
        ...
        if tool_calls:
            ...
            console.print(tc_yaml)
            
        console.section("End of Message")
