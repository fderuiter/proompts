...
- Duplicate name validation in `engine/scripts/validate_prompt_schema.py`.
- `engine/scripts/search_prompts.py` for searching prompts.
- `docs/USAGE.md`.
- `engine/scripts/update_last_modified.py`.
