...
See `docs/template_prompt.prompt.md` for a filled-out example.
...
1. Create prompts as `.prompt.yaml` files that follow [`docs/template_prompt.prompt.md`](docs/template_prompt.prompt.md) and place them in the appropriate folder.
