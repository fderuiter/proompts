...
| :--- | :--- | :--- |
| [`prompt.schema.json`](./prompt.schema.json) | Validates `.prompt.yaml` files. | `engine/scripts/validate_prompt_schema.py` |
...
If you modify the `PromptSchema` class in `engine/scripts/validate_prompt_schema.py`, you must regenerate the schema file:
