...
python3 engine/scripts/run_workflow.py workflows/technical/agentic_coding.workflow.yaml -f inputs.yaml
```
...
```bash
python3 engine/scripts/run_workflow.py workflows/technical/agentic_coding.workflow.yaml -i product_concept="A new time-tracking app" -v
```
