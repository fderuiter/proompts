...
!!! example "Example: Creating an analytics dashboard"
    **Less effective:**
    ```text
...
!!! example "Example: Formatting preferences"
    **Less effective:**
    ```text
    NEVER use ellipses
    ```
...
- **Structure document content and metadata with XML tags**: When using multiple documents, wrap each document in `<document>` tags with `<document_content>` and `<source>` (and other metadata) subtags for clarity.
    ...
    !!! example "Example multi-document structure"
        ```xml
        <documents>
          <document index="1">
...
- **Ground responses in quotes**: For long document tasks, ask Claude to quote relevant parts of the documents first before carrying out its task. This helps Claude cut through the noise of the rest of the document's contents.
    ...
    !!! example "Example quote extraction"
        ```xml
...
!!! example "Context hydration and role consistency"
...
!!! example "Example: Explicit instructions"
...
If you are migrating from [extended thinking](https://docs.anthropic.com/en/docs/build-with-claude/extended-thinking) with `budget_tokens`, replace your thinking configuration and move budget control to `effort`:
...
!!! info
    For more information on thinking capabilities, see [Extended thinking](https://docs.anthropic.com/en/docs/build-with-claude/extended-thinking) and [Adaptive thinking](https://docs.anthropic.com/en/docs/build-with-claude/adaptive-thinking).
...
The [memory tool](https://docs.anthropic.com/en/docs/agents-and-tools/tool-use/memory-tool) pairs naturally with context awareness for seamless context transitions.
...
!!! example "Example: State tracking"
    ```json
...
!!! tip
    For a detailed guide on improving frontend design, see the blog post on [improving frontend design through skills](https://www.anthropic.com/news/improving-frontend-design-through-skills).
...
For detailed migration steps, see the [Migration guide](https://docs.anthropic.com/en/docs/about-claude/models/migration-guide).
...
The extended thinking paths above use `budget_tokens` for predictable token usage. If your workload fits one of the following patterns, consider trying [adaptive thinking](https://docs.anthropic.com/en/docs/build-with-claude/adaptive-thinking) instead:
