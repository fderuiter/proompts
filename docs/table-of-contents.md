...
[CDISC Mapping](../prompts/clinical/data_management/10_cdisc_mapping.prompt.yaml)
[Data De-identification](../prompts/clinical/data_management/11_data_deidentification.prompt.yaml)
[Semantic Interoperability Optimization](../prompts/clinical/data_management/12_semantic_interoperability.prompt.yaml)
[Metadata Management](../prompts/clinical/data_management/13_metadata_management.prompt.yaml)
...
[IQ OQ PQ Validation](../prompts/clinical/eclinical_integration/04_iq_oq_pq_validation.prompt.yaml)
[Audit Trail Review](../prompts/clinical/eclinical_integration/05_audit_trail_review.prompt.yaml)
[UAT Execution](../prompts/clinical/eclinical_integration/06_uat_execution.prompt.yaml)
[Regulatory Compliance Verification](../prompts/clinical/eclinical_integration/07_regulatory_compliance_verification.prompt.yaml)
...
[CRF Design Error Prevention](../prompts/clinical/forms/04_crf_design_error_prevention.prompt.yaml)
[eCRF Implementation](../prompts/clinical/forms/05_ecrf_implementation.prompt.yaml)
...
[Risk-Based Monitoring Plan](../prompts/clinical/monitoring/04_risk_based_monitoring_plan.prompt.yaml)
