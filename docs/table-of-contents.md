...
[Operational Excellence & Risk Sweep](../prompts/management/operations/05_operational_excellence_risk_sweep.prompt.yaml)
[360° Operational KPI & Benchmark Review](../prompts/management/operations/06_operational_kpi_benchmark_review.prompt.yaml)
[Rolling Resource & Capacity Forecast](../prompts/management/operations/07_rolling_resource_capacity_forecast.prompt.yaml)
[Study Start-Up Checklist & Timeline](../prompts/management/operations/08_study_startup_checklist.prompt.yaml)
[Multistudy Resource & Capacity Forecast Plan](../prompts/management/operations/09_multistudy_resource_capacity_forecast_plan.prompt.yaml)
[Proactive Risk Heat-Map for Decentralized & Virtual Trials](../prompts/management/operations/10_proactive_risk_heat_map.prompt.yaml)
[Quarterly CRO KPI Executive Brief](../prompts/management/operations/11_quarterly_kpi_executive_brief.prompt.yaml)
[Weekly Operations KPI Snapshot](../prompts/management/operations/12_weekly_ops_kpi_snapshot.prompt.yaml)
[Action-Oriented Meeting Minutes & Tracker](../prompts/management/operations/13_action_oriented_meeting_minutes.prompt.yaml)
[Fair-Market-Value Budget Negotiation Brief](../prompts/management/operations/14_fair_market_value_budget_negotiation_brief.prompt.yaml)
[Forward-Looking Resource & Capacity Forecast](../prompts/management/operations/15_forward_capacity_forecast.prompt.yaml)
[Risk-Based Vendor Performance Improvement Plan](../prompts/management/operations/16_vendor_performance_improvement_plan.prompt.yaml)
[Fishbone Facilitator](../prompts/management/operations/17_fishbone_facilitator.prompt.yaml)
...
[Project Starter Pack Prompts](../prompts/management/project_management/11_project_starter_pack.prompt.yaml)
[RACI Mapper](../prompts/management/project_management/12_raci_mapper.prompt.yaml)
...
[Sample-Size & Randomization Strategy](../prompts/scientific/biostatistics/11_sample_size_randomization_strategy.prompt.yaml)
[FDA Missing-Data Query Response](../prompts/scientific/biostatistics/12_fda_missing_data_query_response.prompt.yaml)
[Submission-Ready Statistical Analysis Plan](../prompts/scientific/biostatistics/13_submission_ready_sap.prompt.yaml)
[Generate & QC Submission-Ready TLFs](../prompts/scientific/biostatistics/14_submission_ready_tlfs.prompt.yaml)
...
[To-Do List Template](../prompts/technical/software_engineering/lifecycle/06_todo_generation.prompt.yaml)
[E2E Test Discovery Template](../prompts/technical/software_engineering/lifecycle/07_e2e_test_discovery.prompt.yaml)
[Folder and Module Organization](../prompts/technical/software_engineering/lifecycle/07_folder_module_organization.prompt.yaml)
[RequirementsBot Prompt](../prompts/technical/software_engineering/lifecycle/07_requirements_prompt.prompt.yaml)
[Reflexion Agent Bug Patch](../prompts/technical/software_engineering/lifecycle/08_reflexion_agent_bug_patch.prompt.yaml)
...
[DRY Codebase Analysis](../prompts/technical/codebase_analysis/01_dry_codebase_analysis.prompt.yaml)
[Maintainability Codebase Analysis](../prompts/technical/codebase_analysis/02_maintainability_codebase_analysis.prompt.yaml)
[SOLID Codebase Analysis](../prompts/technical/codebase_analysis/03_solid_codebase_analysis.prompt.yaml)
...
[Forge - Script Reliability Agent](../prompts/technical/devops/01_forge_script_reliability.prompt.yaml)
[Atlas Documentation Specialist](../prompts/technical/documentation/01_atlas_documentation_specialist.prompt.yaml)
