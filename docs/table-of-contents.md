...
[Public Hearing Participation](../prompts/regulatory/administrative/07_public_hearing_participation.prompt.yaml)
[Privacy Act Auditing](../prompts/regulatory/administrative/08_privacy_act_auditing.prompt.yaml)
[Informed Consent Exception (Emergency)](../prompts/regulatory/administrative/09_informed_consent_exception_emergency.prompt.yaml)
[Patent Term Restoration Eligibility](../prompts/regulatory/administrative/10_patent_term_restoration_eligibility.prompt.yaml)
[Quality System Audit](../prompts/regulatory/compliance/01_quality_system_audit.prompt.yaml)
[Risk Management Analysis](../prompts/regulatory/compliance/02_risk_management_analysis.prompt.yaml)
[Medical Device Reporting (MDR)](../prompts/regulatory/compliance/03_medical_device_reporting_mdr.prompt.yaml)
[UDI GUDID Submission](../prompts/regulatory/compliance/04_udi_gudid_submission.prompt.yaml)
[Labeling Compliance Audit](../prompts/regulatory/compliance/05_labeling_compliance_audit.prompt.yaml)
[Quality System Evaluation (MRA)](../prompts/regulatory/compliance/06_quality_system_evaluation_mra.prompt.yaml)
[Correction and Removal Reporting](../prompts/regulatory/compliance/07_correction_and_removal_reporting.prompt.yaml)
[GLP Quality Assurance](../prompts/regulatory/compliance/08_glp_quality_assurance.prompt.yaml)
[IRB Protocol Review](../prompts/regulatory/compliance/09_irb_protocol_review.prompt.yaml)
[Medical Device Recall Strategy](../prompts/regulatory/compliance/10_medical_device_recall_strategy.prompt.yaml)
[Off-Label Information Dissemination](../prompts/regulatory/compliance/11_off_label_information_dissemination.prompt.yaml)
[Part 11 Closed System Audit](../prompts/regulatory/compliance/12_part_11_closed_system_audit.prompt.yaml)
[Financial Disclosure Certification](../prompts/regulatory/compliance/13_financial_disclosure_certification.prompt.yaml)
[Cyber Device Security Plan](../prompts/regulatory/compliance/14_cyber_device_security_plan.prompt.yaml)
[Human Factors/Usability Summary](../prompts/regulatory/compliance/15_human_factors_usability_summary.prompt.yaml)
[Automated Image Assessment System 510(k)](../prompts/regulatory/device_specifics/01_automated_image_assessment_system_510k.prompt.yaml)
...
[Carrier Screening System 510(k)](../prompts/regulatory/device_specifics/04_carrier_screening_system_510k.prompt.yaml)
...
[510(k) Substantial Equivalence Preparation](../prompts/regulatory/submissions/01_510k_substantial_equivalence_preparation.prompt.yaml)
...
[RTA Checklist Preparation](../prompts/regulatory/submissions/05_rta_checklist_preparation.prompt.yaml)
[Intended Use and Indications for Use Alignment](../prompts/regulatory/submissions/06_intended_use_and_indications_for_use_alignment.prompt.yaml)
[Shelf-life Study Rationale](../prompts/regulatory/submissions/07_shelf_life_study_rationale.prompt.yaml)
[Humanitarian Device Exemption (HDE)](../prompts/regulatory/submissions/08_humanitarian_device_exemption_hde.prompt.yaml)
[PMA Supplement (CBE)](../prompts/regulatory/submissions/09_pma_supplement_cbe.prompt.yaml)
[De Novo Request Preparation](../prompts/regulatory/submissions/10_de_novo_request_preparation.prompt.yaml)
[Reclassification Petitioning](../prompts/regulatory/submissions/11_reclassification_petitioning.prompt.yaml)
[Parallel Review Request](../prompts/regulatory/submissions/12_parallel_review_request.prompt.yaml)
[Combination Product Jurisdiction](../prompts/regulatory/submissions/13_combination_product_jurisdiction.prompt.yaml)
[Medicare Coverage Request (IDE)](../prompts/regulatory/submissions/14_medicare_coverage_request_ide.prompt.yaml)
