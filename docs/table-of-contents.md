...
[21 CFR Part 14 Auditing](../prompts/regulatory/compliance/21_cfr_part_14_auditing.prompt.yaml)
...
[Financial Disclosure Certification](../prompts/regulatory/compliance/financial_disclosure_certification.prompt.yaml)
[Food Safety Audit Reporting (Regulatory)](../prompts/regulatory/compliance/food_safety_audit_reporting_regulatory.prompt.yaml)
[Foreign Supplier Verification Program (FSVP) Audit](../prompts/regulatory/compliance/foreign_supplier_verification_program_fsvp_audit.prompt.yaml)
[GLP Quality Assurance](../prompts/regulatory/compliance/glp_quality_assurance.prompt.yaml)
[Human Factors/Usability Summary](../prompts/regulatory/compliance/human_factors_usability_summary.prompt.yaml)
[Informed Consent Exception (Emergency)](../prompts/regulatory/compliance/informed_consent_exception_emergency.prompt.yaml)
...
[Off-Label Information Dissemination](../prompts/regulatory/compliance/off_label_information_dissemination.prompt.yaml)
[Part 11 Closed System Audit](../prompts/regulatory/compliance/part_11_closed_system_audit.prompt.yaml)
[Quality System Audit](../prompts/regulatory/compliance/quality_system_audit.prompt.yaml)
[Quality System Evaluation (MRA)](../prompts/regulatory/compliance/quality_system_evaluation_mra.prompt.yaml)
[Risk Management Analysis](../prompts/regulatory/compliance/risk_management_analysis.prompt.yaml)
[Special Controls Labeling Compliance](../prompts/regulatory/compliance/special_controls_labeling_compliance.prompt.yaml)
[UDI GUDID Submission](../prompts/regulatory/compliance/udi_gudid_submission.prompt.yaml)
...
[Automated Image Assessment System 510(k)](../prompts/regulatory/submissions/automated_image_assessment_system_510_k.prompt.yaml)
[Carrier Screening System 510(k)](../prompts/regulatory/submissions/carrier_screening_system_510_k.prompt.yaml)
...
[Intended Use and Indications for Use Alignment](../prompts/regulatory/submissions/intended_use_and_indications_for_use_alignment.prompt.yaml)
...
[Reclassification Petitioning](../prompts/regulatory/submissions/reclassification_petitioning.prompt.yaml)
[RTA Checklist Preparation](../prompts/regulatory/submissions/rta_checklist_preparation.prompt.yaml)
[Shelf-life Study Rationale](../prompts/regulatory/submissions/shelf_life_study_rationale.prompt.yaml)
