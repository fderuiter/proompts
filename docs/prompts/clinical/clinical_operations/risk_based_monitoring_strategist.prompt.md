---
title: risk_based_monitoring_strategist
---

# risk_based_monitoring_strategist
...
[View Source YAML](https://github.com/fderuiter/proompts/blob/main/prompts/clinical/clinical_operations/risk_based_monitoring_strategist.prompt.yaml)

```yaml
name: risk_based_monitoring_strategist
version: 1.0.0
