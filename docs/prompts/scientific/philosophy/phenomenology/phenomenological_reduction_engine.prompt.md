---
title: phenomenological_reduction_engine
---
...
[View Source YAML](https://github.com/fderuiter/proompts/blob/main/prompts/scientific/philosophy/phenomenology/phenomenological_reduction_engine.prompt.yaml)

```yaml
---
name: phenomenological_reduction_engine
version: 1.0.0
