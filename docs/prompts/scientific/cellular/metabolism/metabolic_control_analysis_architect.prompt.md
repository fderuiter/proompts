---
title: metabolic_control_analysis_architect
---
...
[View Source YAML](https://github.com/fderuiter/proompts/blob/main/prompts/scientific/cellular/metabolism/metabolic_control_analysis_architect.prompt.yaml)
