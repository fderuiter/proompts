---
title: ambiguous_natural_language_fol_formalizer
---

# ambiguous_natural_language_fol_formalizer
...
[View Source YAML](https://github.com/fderuiter/proompts/blob/main/prompts/scientific/formal_logic/systems/first_order_logic/ambiguous_natural_language_fol_formalizer.prompt.yaml)

```yaml
---
name: ambiguous_natural_language_fol_formalizer
version: 1.0.0
description: Systematically translates structurally ambiguous natural language propositions into rigorous, fully scoped First-Order Logic (FOL) formulas, resolving quantifier scope ambiguities.
authors:
...
variables:
  - name: natural_language_statement
    description: The ambiguous natural language statement to be formalized into FOL.
    required: true
  - name: domain_of_discourse
    description: The intended domain of discourse for the formalization.
    required: true
...
testData:
  - inputs:
      natural_language_statement: 'Every boy loves a girl.'
      domain_of_discourse: 'Humans'
    variables: {}
  - inputs:
      natural_language_statement: 'All politicians deceive some voters.'
      domain_of_discourse: 'People'
    variables: {}
evaluators:
  - type: regex
    pattern: '\\forall'
