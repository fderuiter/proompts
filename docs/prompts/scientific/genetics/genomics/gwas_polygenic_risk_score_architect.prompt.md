---
title: gwas_polygenic_risk_score_architect
---
...
[View Source YAML](https://github.com/fderuiter/proompts/blob/main/prompts/scientific/genetics/genomics/gwas_polygenic_risk_score_architect.prompt.yaml)
