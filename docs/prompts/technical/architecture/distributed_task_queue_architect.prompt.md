---
title: Distributed Task Queue and Background Job Processing Architect
---
...
[View Source YAML](https://github.com/fderuiter/proompts/blob/main/prompts/technical/architecture/distributed_task_queue_architect.prompt.yaml)
