---
title: Underwater Acoustic Sensor Network Architect
---
...
[View Source YAML](https://github.com/fderuiter/proompts/blob/main/prompts/technical/architecture/underwater_acoustic_sensor_network_architect.prompt.yaml)
