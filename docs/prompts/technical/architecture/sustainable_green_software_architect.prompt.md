---
title: Sustainable Green Software Architect
---
...
[View Source YAML](https://github.com/fderuiter/proompts/blob/main/prompts/technical/architecture/sustainable_green_software_architect.prompt.yaml)
