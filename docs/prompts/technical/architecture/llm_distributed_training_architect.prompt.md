---
title: LLM Distributed Training Architect
---
...
[View Source YAML](https://github.com/fderuiter/proompts/blob/main/prompts/technical/architecture/llm_distributed_training_architect.prompt.yaml)
