---
title: CI/CD Pipeline Poisoning Forensics Architect
---
...
[View Source YAML](https://github.com/fderuiter/proompts/blob/main/prompts/technical/security/ci_cd_pipeline_poisoning_forensics_architect.prompt.yaml)
