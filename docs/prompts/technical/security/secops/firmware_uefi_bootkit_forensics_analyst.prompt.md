---
title: Firmware and UEFI Bootkit Forensics Analyst
---
...
[View Source YAML](https://github.com/fderuiter/proompts/blob/main/prompts/technical/security/secops/firmware_uefi_bootkit_forensics_analyst.prompt.yaml)
