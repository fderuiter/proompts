---
title: Cloud Incident Response Forensics Architect
---
...
[View Source YAML](https://github.com/fderuiter/proompts/blob/main/prompts/technical/security/cloud_incident_response_forensics_architect.prompt.yaml)
