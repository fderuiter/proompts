---
title: Calibrated Autonomous Agent
---

# Calibrated Autonomous Agent

Executes a fully autonomous repository commit and generates a pull request based on the current workspace state.

[View Source YAML](https://github.com/fderuiter/proompts/blob/main/prompts/technical/automation/calibrated_autonomous_agent.prompt.yaml)

```yaml
---
name: Calibrated Autonomous Agent
version: "1.0.0"
...
testData:
  - variables:
      workspace_state: "Modified code for auth flow."
    expected: "Zero-Interaction Protocol"
evaluators:
  - name: Constraints match
    string:
      contains: "Zero-Interaction Protocol"
