---
title: Value-Based QBR Generator
---
...
- role: user
  content: 'My team spends too much time building Quarterly Business Reviews (QBRs) that clients find boring.
...
testData:
- input:
    client_data: 'Goal: Increase leads by 20%
