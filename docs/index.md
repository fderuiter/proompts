...
- [Clinical Endpoint Assessment Tool Analyzer](../prompts/scientific/biostatistics/13_clinical_endpoint_analyst.prompt.yaml)
- [Estimand Framework & Methodology Evaluator](../prompts/scientific/biostatistics/14_estimand_framework_evaluator.prompt.yaml)
...
- [Build Endpoint Assessment Tool](../prompts/technical/software_engineering/tasks/15_build_endpoint_analyzer.prompt.yaml)
...
- [Endpoint Data Model Architect](../prompts/technical/architecture/07_endpoint_data_model.prompt.yaml)
