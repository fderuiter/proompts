...
- [Protocol to USDM Stage 1 - Metadata](../prompts/clinical/protocol/07_usdm_stage1_metadata.prompt.yaml)
- [Protocol to USDM Stage 2 - Rationale](../prompts/clinical/protocol/08_usdm_stage2_rationale.prompt.yaml)
- [Protocol to USDM Stage 3 - Workflow](../prompts/clinical/protocol/09_usdm_stage3_workflow.prompt.yaml)
- [Protocol to USDM Stage 4 - Concepts](../prompts/clinical/protocol/10_usdm_stage4_concepts.prompt.yaml)
- [Protocol to USDM Stage 5 - Assembly](../prompts/clinical/protocol/11_usdm_stage5_assembly.prompt.yaml)
...
- [Compassionate Analyst](../prompts/clinical/therapy/01_compassionate_analyst.prompt.yaml)
- [ISO Strategist](../prompts/clinical/therapy/02_iso_strategist.prompt.yaml)
- [Sonic Architect](../prompts/clinical/therapy/03_sonic_architect.prompt.yaml)
- [Lyricist](../prompts/clinical/therapy/04_lyricist.prompt.yaml)
