...
flowchart TD
    ...
    e2e_test_discovery["e2e_test_discovery<br/><small>testing_prompts/01_e2e_test_discovery.prompt.yaml</small>"]
    design_verification["design_verification<br/><small>testing_prompts/02_design_verification_test_plan.prompt.yaml</small>"]
    human_factors_validation["human_factors_validation<br/><small>testing_prompts/03_human_factors_validation_study_protocol.prompt.yaml</small>"]
    risk_based_test_suite["risk_based_test_suite<br/><small>testing_prompts/04_risk_based_test_case_suite.prompt.yaml</small>"]
