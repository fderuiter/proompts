...
flowchart TD
    ...
    imaging_charter_draft["imaging_charter_draft<br/><small>imaging_prompts/01_imaging_charter_draft.prompt.yaml</small>"]
    site_upload_qc["site_upload_qc<br/><small>imaging_prompts/02_site_upload_qc.prompt.yaml</small>"]
    central_reading_design["central_reading_design<br/><small>imaging_prompts/03_central_reading_design.prompt.yaml</small>"]
    regulatory_imaging_charter["regulatory_imaging_charter<br/><small>imaging_prompts/04_regulatory_imaging_charter_generator.prompt.yaml</small>"]
    image_acquisition_qc_workflow["image_acquisition_qc_workflow<br/><small>imaging_prompts/05_image_acquisition_qc_workflow_blueprint.prompt.yaml</small>"]
    regulatory_imaging_data_package["regulatory_imaging_data_package<br/><small>imaging_prompts/06_regulatory_imaging_data_package.prompt.yaml</small>"]
