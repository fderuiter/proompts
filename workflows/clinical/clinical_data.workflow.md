...
flowchart TD
    ...
    discrepancy_detection["discrepancy_detection<br/><small>prompts/clinical/data/01_discrepancy_detection_query_log.prompt.yaml</small>"]
    dmp_section["dmp_section<br/><small>prompts/clinical/data/02_data_management_plan_section.prompt.yaml</small>"]
    edit_check_specification["edit_check_specification<br/><small>prompts/clinical/data/03_edit_check_specification_builder.prompt.yaml</small>"]
