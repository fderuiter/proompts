...
flowchart TD
    ...
    design_protocol["design_protocol<br/><small>pathology_prompts/01_study_protocol_outline.prompt.yaml</small>"]
    evaluate_interface["evaluate_interface<br/><small>pathology_prompts/02_device_tissue_interface_evaluation.prompt.yaml</small>"]
    plan_reporting["plan_reporting<br/><small>pathology_prompts/03_slides_and_reporting_workflow.prompt.yaml</small>"]
