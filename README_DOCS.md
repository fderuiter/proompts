...
2. **Generated Artifacts (Do NOT edit manually, Do NOT commit)**
   These files are automatically generated by the scripts in `tools/tools/scripts/` as build artifacts. Any manual changes made to them will be overwritten during the next CI/CD build or local script execution, and they should not be committed to git.
